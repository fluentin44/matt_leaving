...
This aimed to develop the start of an ATACseq pipeline. This pipeline currently:
...
# for i in "${arr[@]}"
# do
# 	arr_names+=("$(echo $i | cut -d'_' -f 1-2)")
# done
# declare -p arr_names
...
# find /scratch/moh1u21/ATAC_seq_test/data/demultiplexed_reads/ATAC_seq_test/ -maxdepth 1 -type f | cut -d"_" -f1-2 | sort | uniq > fast_files.txt
...
# -p \
# --length_required 50 \
# -i data/demultiplexed_reads/ATAC_seq_test/${i}_R1_001.fastq.gz \
# -I data/demultiplexed_reads/ATAC_seq_test/${i}_R2_001.fastq.gz \
# -o data/demultiplexed_reads/trimmed/trimmed_${i}_R1_001.fastq.gz \
# -O data/demultiplexed_reads/trimmed/trimmed_${i}_R2_001.fastq.gz \
...
# --cut_tail \
# --cut_mean_quality 30 \
# --html results/reports/fastp/trimmed_${i}_fastp_report.html \
# --json results/reports/fastp/trimmed_${i}_fastp_report.json >> $fastp_logfile 2>&1
...
bowtie2 --very-sensitive \
 ...
 -S results/{}_test_aligned.sam 2>> {}_bt2log_test_aligned.log
...
cat fast_files.txt | parallel \
samtools view -h -S -b {}_test_aligned.sam -o {}_test_aligned.bam 
